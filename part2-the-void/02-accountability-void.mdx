...
This is a structural failure in the accountability infrastructure, not a minor UX problem. Without calibrated confidence (a reliable signal that says "this claim is 92% likely correct" versus "this claim is 55% likely correct, you should check it"), human-in-the-loop governance is theater. The human is reviewing everything or reviewing nothing, because the system provides no guidance about where human attention is most needed.
