...
The officer did not disappear. The work changed. The officer moved from executing the documentation (typing, formatting, looking up codes, structuring narratives) to governing the AI's output: reviewing, correcting, approving. The cognitive work shifted from production to quality assurance. The officer's domain expertise becomes more valuable, not less: knowing what matters in an incident, recognizing when a detail sounds wrong, understanding which elements have legal significance. It is the judgment that matters, not the typing.

One important workforce transition is from producing routine outputs to evaluating and governing assisted work. It is neither universal nor guaranteed to preserve every job. The outcome depends on how tasks are reorganized, who retains decision authority, and how organizations use the capacity they recover.

## The Governor, Not the Executor

The police example illustrates a pattern that can apply to parts of many professions. These are possible workflow designs, not claims that every organization has adopted them or that professional judgment is beyond automation.
...
Selective review needs several signals: uncertainty, potential consequences, unusual inputs, and evidence of systematic errors. Confidence can help prioritize attention when it is evaluated for the task. Periodic sampling of apparently easy cases and an effective appeal path can reveal problems the confidence model misses.

This changes what workforce development has to produce. The governance skill is domain expertise plus the ability to interpret and act on uncertainty signals, a step beyond AI literacy. The accountant needs to understand what a 60% confidence score means for an expense classification in the specific context of their organization's chart of accounts, their materiality thresholds, and their audit requirements. The physician needs to understand what it means when the AI is 70% confident in a blood pressure medication recommendation: what the number means clinically, for this patient, with this history, beyond what it means statistically. Calibrated confidence becomes a professional skill, as fundamental to the AI-augmented professional as reading financial statements is to the traditional accountant.

## The Education Gap

The transition exposes a gap between learning to perform a task and learning to supervise systems that perform it. Both require deliberate teaching.
...
Education needs to connect foundational practice with explicit governance: evaluating output for correctness and appropriateness, defining a workflow's purpose, measuring performance, and deciding when to intervene. The gap varies by institution. The workshops described here show the needs I encountered, rather than establish that every program neglects these skills.
...
The certification gap matters because it shapes procurement. Government buyers default to incumbent vendors out of fear, not preference. They lack the vocabulary to evaluate AI vendors, so they buy from the name they recognize. Whoever teaches them the evaluation framework shapes the procurement criteria. A structured certification (AI Operator, AI Architect, AI Manager) trains individuals, but its larger effect is a shared language that procurement officers, CIOs, and evaluation committees can use to compare vendors and assess proposals. The emotional unlock matters as much as the technical skills. The first step is "believe you can do this." "Learn these tools" comes after.

Education can introduce people to the platform while giving them skills they can use elsewhere. A credible curriculum should teach transferable concepts, compare alternatives, and distinguish a vendor's implementation from the underlying standard. The commercial relationship is stronger when graduates can choose the tools they use.
...
But even where talent exists, a subtler gap persists. In one mid-sized Canadian city, the entrepreneurs building AI companies did not know each other existed. No introductions had been made, no first-customer relationships had formed, no shared procurement wins had materialized. The ecosystem gap is not a talent gap: the builders are not buying from each other. Without those first local transactions, the flywheel of reference customers, shared learnings, and collective credibility never starts spinning.
...
AI-assisted work can expose learners to more cases, but exposure is not the same as understanding. Reviewing a polished answer may conceal the reasoning required to produce it. Training should include independent attempts, explanation, feedback, and exercises where the automated answer is deliberately withheld.

Promotion should reflect demonstrated judgment rather than document volume alone. A reviewer who has seen thousands of outputs needs to show that they can recognize unfamiliar failures, explain a decision, and work when the automated system is unavailable. More cases create an opportunity to learn; they do not establish that learning occurred.
...
Jobs are bundles of tasks. Automating some tasks can change a role, reduce the number of people needed, expand demand for the service, or eliminate the role. Task-level capability alone cannot tell us which outcome will occur. Workers need a voice in that redesign and practical support when their livelihood changes.
...
The problem here is policy, education, and ultimately political will, not technology. The technology transition is happening regardless. The question is whether the workforce transition is managed or endured: whether organizations, educators, and governments invest in moving people from execution to governance, or whether they let the market sort it out and accept the consequences.

The transition can give people more meaningful work and more time, but those gains have to be designed and shared. Paid learning time, opportunities to practice, participation in workflow decisions, and support during displacement belong in the plan. Governance is one valuable human activity; care, craft, relationships, and curiosity deserve room too.