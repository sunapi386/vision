...
In January 2025, OpenAI and its partners announced Stargate, with a [plan to invest $500 billion over four years](https://openai.com/index/announcing-the-stargate-project/) in US AI infrastructure. The figure describes an announced plan, not completed spending. It makes the ownership question hard to ignore.

I am betting on distributed ownership with interoperable protocols. Hospitals, firms, schools, and individuals should be able to own useful AI capability and choose when to buy more. Centralized services will have a place. The future I want gives their customers the power to refuse terms and take their essential work elsewhere.

That ambition puts a demanding obligation on the architecture: make ownership usable, make dependence visible, and make exit work. A server under the desk is only the beginning.
